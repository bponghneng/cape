...
{"files_modified":["path/to/file1.ext","path/to/file2.ext"],"git_diff_stat":"Output string from git diff --stat","output":"implement","planPath":"Relative path to the implemented plan file","status":"completed","summary": "Concise summary of the implemented work"}
