...
- Apply a **simplicity-first** mindset (see `mexican-train/CLAUDE.md`): prefer the smallest coherent implementation that delivers the desired value, avoid premature abstractions, and keep dependencies minimal.
