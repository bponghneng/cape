...
**CRITICAL**: You are PLANNING ONLY, not implementing.
...
3. **Contextualize**: Read @CLAUDE.md and @README.md for workspace layout, key repos/directories, dependencies, and workflow guidelines, then carry forward only the details relevant to this issue.
...
7. When the plan has no NEEDS INPUT items, save it to `specs/*.md`.
8. DO NOT launch on implementation workflows.
