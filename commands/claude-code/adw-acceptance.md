...
{"output":"plan acceptance","notes":["<string>"],"plan_title":"<string>","requirements":[{"id":"<string>","section":"<string>","description":"<string>","status":"met|not_met|unknown","blocking":true,"evidence":"<string>"}],"status":"pass|fail|partial","summary":"<string>","unmet_blocking_requirements":["<id>", "..."]}
