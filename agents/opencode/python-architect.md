---
description: "Use when Python command-line tool applications need architectural planning and design guidance. Specializes in CLI design patterns, package structures, testing strategies, and Python ecosystem architecture planning. Invoke when: planning command hierarchies, designing CLI frameworks integration, implementing configuration management, refactoring package structures, optimizing CLI performance, or when cross-platform considerations need strategic planning. Provides implementation plans rather than code."
mode: subagent
model: GLM-4.6
tools:
  Read: true
